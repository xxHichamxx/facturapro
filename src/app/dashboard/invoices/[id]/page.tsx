    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Link href={`/dashboard/invoices/${document.id}/edit`}>
        ...
        <CardContent className="p-8">
          <div className="mb-8 flex justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Patente: {company?.patente}</p>
            </div>
            <div className="text-right">
              <h2 className="text-xl font-bold text-primary-dark">FACTURE</h2>
          ...
          <div className="mb-8 rounded-lg bg-muted p-4">
            ...
            {(document as any).client?.ice_client && (
              <p className="text-sm text-muted-foreground">
                ICE: {(document as any).client?.ice_client}
              </p>
            )}
          </div>
